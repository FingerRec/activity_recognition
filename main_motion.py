...
class Motion_CNN():
    ...
    def run(self):
        ...
        for self.epoch in range(self.start_epoch, self.nb_epochs):
            ...
            },is_best, opt.temporal_checkpoint_path, opt.temporal_best_model_path)
    ...
    def train_1epoch(self):
        ...
        record_info(info, opt.flow_train_record_path,'train')
    ...
    def validate_1epoch(self):
        ...
        record_info(info, opt.flow_test_record_path, 'test')
