...
class Spatial_CNN():
    ...
    def run(self):
        ...
        for self.epoch in range(self.start_epoch, self.nb_epochs):
            ...
            },is_best,opt.spatial_checkpoint_path,opt.spatial_best_model_path)
    #训练集，训练1epoch
    def train_1epoch(self):
        ...
        record_info(info, opt.rgb_train_record_path,'train')
    ...
    def validate_1epoch(self):
        ...
        record_info(info, opt.rgb_test_record_path, 'test')
