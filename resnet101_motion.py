...
parser.add_argument('--resume', default = '/media/zdwyf1/Elements/DataSet/charades/model_best.pth.tar', type=str, metavar='PATH', help='path to latest checkpoint (default: none)')
