...
class Motion_CNN():
    ...
    def build_model(self):
        ...
        #self.model = Inceptionv4.inceptionv4_101(num_classes=101, pretrained='imagenet', channel=20)
        self.model = bninception.bninception_101(num_classes=101, pretrained='imagenet', channel=20).cuda()
        # print self.model
    ...
    def run(self):
        ...
        for self.epoch in range(self.start_epoch, self.nb_epochs):
            ...
            if self.epoch % 10 == 0 and self.epoch > 0:
                ...
                }, is_best, opt.bninception_temporal_checkpoint_path, opt.bninception_temporal_best_model_path)
    ...
    def validate_1epoch(self):
        ...
        record_info(info, opt.bninception_flow_test_record_path, 'test')
