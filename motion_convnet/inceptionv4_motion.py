...
#from models import bninception
from data import inception_motion_dataloader
...
def main():
    ...
    # Prepare DataLoader
    data_loader = inception_motion_dataloader.Motion_DataLoader(
...
class Motion_CNN():
    ...
    def build_model(self):
        ...
        # build model, 已经是在imageNet上预训练过的
        self.model = Inceptionv4.inceptionv4_101(num_classes=101, pretrained='imagenet', channel=20).cuda()
        #self.model = bninception.bninception_101(num_classes=101, pretrained='imagenet', channel=20)
        # print self.model
    ...
    def resume_and_evaluate(self):
        if self.resume:
            if os.path.isfile(self.resume):
                ...
                self.optimizer.load_state_dict(checkpoint['optimizer'])  # 加载优化函数
    ...
    def run(self):
        ...
        for self.epoch in range(self.start_epoch, self.nb_epochs):
            ...
            }, is_best, opt.Inceptionv4_temporal_checkpoint_path, opt.Inceptionv4_temporal_best_model_path)
    ...
    def train_1epoch(self):
        ...
        record_info(info, opt.Inceptionv4_flow_train_record_path, 'train')
    ...
    def validate_1epoch(self):
        ...
        record_info(info, opt.Inceptionv4_flow_test_record_path, 'test')
