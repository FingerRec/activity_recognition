...
from data import resnet101_tsn_motion_dataloader
...
def main():
    ...
    # Prepare DataLoader
    data_loader = resnet101_tsn_motion_dataloader.Motion_DataLoader(
        BATCH_SIZE=arg.batch_size,
        num_workers=8,
        path=opt.temporal_train_data_root,
        ucf_list=opt.ucf_list,
        ucf_split=opt.ucf_split,
        in_channel=4  # the flow stack number
    )
...
class Motion_CNN():
    ...
    def train_1epoch(self):
        ...
        record_info(info, opt.ResNet101_flow_train_record_path, 'train')
    ...
    def validate_1epoch(self):
        ...
        record_info(info, opt.ResNet101_flow_test_record_path, 'test')
