...
class Spatial_CNN():
    ...
    def build_model(self):
        ...
        # build model
        self.model = bninception.bninception_101(num_classes=101, pretrained='imagenet', channel=3).cuda()  #
    ...
    def validate_1epoch(self):
        ...
        record_info(info, opt.bninception_rgb_test_record_path, 'test')
