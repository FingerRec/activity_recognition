...
from data import inception_spatial_dataloader
...
def main():
    ...
    # Prepare DataLoader
    data_loader = inception_spatial_dataloader.spatial_dataloader(
...
class Spatial_CNN():
    ...
    def build_model(self):
        ...
        # build model
        self.model = Inceptionv4.inceptionv4_101(num_classes=101, pretrained='imagenet', channel=3).cuda()  #
    ...
    def run(self):
        ...
        for self.epoch in range(self.start_epoch, self.nb_epochs):
            ...
            }, is_best, opt.Inceptionv4_spatial_checkpoint_path, opt.Inceptionv4_spatial_best_model_path)
    ...
    def train_1epoch(self):
        ...
        record_info(info, opt.Inceptionv4_rgb_train_record_path, 'train')
    ...
    def validate_1epoch(self):
        ...
        record_info(info, opt.Inceptionv4_rgb_test_record_path, 'test')
